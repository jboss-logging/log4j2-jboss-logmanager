...
Want to contribute to the log4j2-jboss-logmanager? We try to make it easy, and all contributions, even the smaller ones,
...
All original contributions to log4j2-jboss-logmanager are licensed under the
...
This project uses https://github.com/jboss-logging/log4j2-jboss-logmanager/issues[GitHub Issues] for filing issues.
...
log4j2-jboss-logmanager has a strictly enforced code style. Code formatting is done by the Eclipse code formatter, using the config files
